...
func (c *Cli) Parse() {
    ...
    flag.BoolVar(&c.Update, "update", false, "Updates the Selene binary to the latest version.")
    flag.BoolVar(&c.Update, "upgrade", false, "Updates the Selene binary to the latest version.")
    flag.BoolVar(&c.Update, "u", false, "Updates the Selene binary to the latest version.")
